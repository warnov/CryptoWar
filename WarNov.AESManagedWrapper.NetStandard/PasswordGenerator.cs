...
namespace WarNov.AESManagedWrapper.NetStandard
{
    public class PasswordGenerator
    {
        ...
        {
            // Pick random length between minimum and maximum if length = 1 or the value of length
            int pwdLength = _length == -1 ? GetCryptographicRandomNumber(this.Minimum, this.Maximum) : _length;
